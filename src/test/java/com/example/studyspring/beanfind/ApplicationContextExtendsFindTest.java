...
public class ApplicationContextExtendsFindTest {
    ...
    void findBeanByParentTypeBeanName() {
        DiscountPolicy discountPolicy = ac.getBean("reateDiscountPolicy", DiscountPolicy.class);
    ...
    // Object로 조회하면 Spring Bean에 등록된 모든 Bean이 출력된다. ( Spring 에서 자체적으로 사용하고자 등록된 Bean까지 전부 조회한다. )
    @Test
    @DisplayName("부모 타입으로 모두 조회하기 - Object 타입으로 전부 조회하기")
